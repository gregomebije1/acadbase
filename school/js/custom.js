$(document).ready(function() {
  ...
  $("#student_name").autocomplete({
	...
	source: function(req, add){
	  $url = "get_students_as_json.php?sessid=" + document.form1.sessid.value + "&class_id1=" + document.form1.class_id1.value + "&school_id=" + document.form1.school_id.value + "&callback=?";
