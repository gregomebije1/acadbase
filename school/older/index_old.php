...
<head>
  ...
  * {
  ...
  table {
   border-top: 10em #425073 solid;
   border-left: 15em #425073 solid;
...
<body>
 ...
 <table border="0">
  <tr><td colspan='4'><h2>AcadPro</h2></td></tr>
  <?php
  if (!empty($message)) 
    echo "<tr><td><b style='color:red;'>$message</b></td></tr>";
  else 
    echo "<tr><td><b style='color:red;'>Log in</b></td></tr>";
  ?>
  <tr>
   <td>Username</td>
  ...
  <tr>
   <td class='style1' colspan='3'><input type='submit'   value='     Login      '></td>
