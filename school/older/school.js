...
function get_student_fees() {
   ...
   var url = "http://" + host + "/school/get_student_fees.php?session_id=" + session_id + "&term_id=" + term_id + "&class_id=" + class_id + "&student_id=" + student_id + "&rand=" + Math.random();
...
function get_students() {
   ...
   var class_id = document.form1.class_id.options[sIndex].value;
   var host = window.location.hostname;
   var url = "http://" + host + "/school/get_students.php?class_id=" + class_id + "&rand=" + Math.random();
...
function get_subject() {
   ...
   var url = "http://" + host + "/school/get_subject.php?class_id=" + class_id + "&rand=" + Math.random();;
   url += "&uid="+uid;
...
function get_terms(source_id, target_id) {
  ...
  var host = window.location.hostname;
  var url = "http://" + host + "/school/get_terms.php?session_id=" + session_id + "&rand=" + Math.random();
...
function get_students_with_size(size) {
   ...
   var class_id = document.form1.class_id.options[sIndex].value;
   var host = window.location.hostname;
   var url = "http://" + host + "/school/get_students.php?class_id=" + class_id + "&rand=" + Math.random() + "&size=10";
...
function get_students_with_all() {
   ...
   var class_id = document.form1.class_id.options[sIndex].value;
   var host = window.location.hostname;
   var url = "http://" + host + "/school/get_students.php?class_id=" + class_id + "&rand=" + Math.random() + "&all=all";
   get_objects(url, 'students');
}  
